...
namespace TodoREST
{
	public partial class OnlineProductPage : ContentPage
	{
		bool isNewItem;
        public DateTime _updatedDate;

		public OnlineProductPage (bool isNew = false)
		{
			InitializeComponent();
			isNewItem = isNew;
        ...
        async void OnGetActivated(object sender, EventArgs e)
        {
            ...
            string test = await App.TodoManager.GetTasksAsyncNew(Convert.ToInt32(OnlineProduct.Id));
        ...
        async void OnSaveActivated (object sender, EventArgs e)
		{
            ...
            await App.TodoManager.SaveTaskAsync (OnlineProduct, isNewItem);
		...
		{
			var OnlineProduct = (OnlineProduct)BindingContext;
			await App.TodoManager.DeleteTaskAsync (OnlineProduct);
			await Navigation.PopAsync ();
		}
